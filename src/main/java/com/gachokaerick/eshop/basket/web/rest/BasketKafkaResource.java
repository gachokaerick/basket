...
@RestController
@RequestMapping("/api/basket-kafka")
public class BasketKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BasketKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public BasketKafkaResource(KafkaProperties kafkaProperties) {
